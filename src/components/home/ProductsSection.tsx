            ...
            {currentProducts.map((product, index) => (
              ...
              >
                ...
                <div className="relative aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 p-4">
                  {/* DIN Badge */}
                  <div className="absolute top-2 left-2 bg-gray-700 text-white text-xs font-bold px-2 py-0.5 rounded">
                    {product.din}
                  </div>
                ...
                {/* Product Name Footer */}
                <div className="bg-steel-700 py-3 px-3">
                  <h3 className="text-white text-center font-semibold uppercase text-xs tracking-wide">
                    {product.name}
                  </h3>
                </div>
              </div>
