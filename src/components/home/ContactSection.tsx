        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4 mb-8">
              {/* Contact Person */}
              <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:border-accent-500/50 transition-colors shadow-sm">
                ...
                <div>
                  <p className="text-steel-500 text-sm">Contact Person</p>
                  <p className="text-accent-500 font-bold">DILIP JAJU</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:border-accent-500/50 transition-colors shadow-sm">
                ...
                <div>
                  <p className="text-steel-500 text-sm">Call Us</p>
                  <a href="tel:+919849108501" className="text-steel-800 font-semibold hover:text-accent-500 transition-colors">
                    +91 98491 08501
                  </a>
                  <span className="text-steel-400 mx-2">|</span>
                  <a href="tel:+919121285022" className="text-steel-800 font-semibold hover:text-accent-500 transition-colors">
                    9121285022
                  </a>
                </div>
              </div>
              ...
              {/* WhatsApp */}
              <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:border-green-500/50 transition-colors shadow-sm">
                ...
                <div>
                  <p className="text-steel-500 text-sm">WhatsApp</p>
                  <a 
                    href="https://wa.me/919058935670" 
                    className="text-steel-800 font-semibold hover:text-green-500 transition-colors"
                    target="_blank"
              ...
              <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:border-accent-500/50 transition-colors shadow-sm">
                ...
                <div>
                  ...
                  <a href="mailto:dilip.dwarkafasteners@gmail.com" className="text-steel-800 font-semibold hover:text-accent-500 transition-colors">
              ...
              <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:border-accent-500/50 transition-colors shadow-sm">
                ...
                <div>
                  <p className="text-steel-500 text-sm">Address</p>
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-lg bg-steel-100 text-steel-600 flex items-center justify-center hover:bg-accent-500 hover:text-white transition-all"
                aria-label="Facebook"
              >
